...
public class Character : Entity, IDamagable
{
    ...
    protected override void InitComponents()
    {
        ...
        _jumper.Init(_jumpPower, _rigidBody);
    ...
    public void TryPickUp(Item pickable)
    {
        if (pickable is HealthItem)
        {
